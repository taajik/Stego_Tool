...
var payload_text_label = document.getElementById('payload_text_label');
var payload_file_label = document.getElementById('payload_file_label');
...
payload_text_label.addEventListener('click', function() {
    payload_text_label.style.fontWeight = 'bold';
    payload_file_label.style.fontWeight = 'normal';
...
payload_file_label.addEventListener('click', function() {
    payload_file_label.style.fontWeight = 'bold';
    payload_text_label.style.fontWeight = 'normal';
